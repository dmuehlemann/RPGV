...
var_ref = 'Variability with estimated installed PV capacity for 2030)' #'Variability with installed PV capacity planned for 2030'
var_calc = 'Variability with minimal in-land PV production as constraint (S4)'
IC_2019_name = 'Installed PV capacity 2019'
IC_ref_name = 'Installed PV capacity 2030'
IC_calc_name = 'Installed PV capacity of scenario 4 (2030)'
