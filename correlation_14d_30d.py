# -*- coding: utf-8 -*-
"""
Created on Wed Sep 30 16:25:43 2020
...
plt.suptitle("Mean weather regime fields (standardized anomalies 14days vs. 30days lowpass filter (2/0.25))", fontsize=20)
plt.savefig("../data/fig/wr_plot_14days_lowpass_2_0-25_corr_30days.png")
