...
plt.suptitle("Mean weather regime fields (standardized anomalies 14days + lowpass filter (2/0.1))", fontsize=20)
plt.savefig("../data/fig/wr_plot_14days_lowpass_2_0-1.png")
