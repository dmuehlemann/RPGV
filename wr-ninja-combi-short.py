# -*- coding: utf-8 -*-
"""
Created on Wed Sep  9 16:55:48 2020
...
f_in = data_folder / 'wr_time-c7_std_short.nc'
f_out1 = data_folder / 'results/mean_wr_country_c4_short.csv'
f_out2 = data_folder / 'results/relative_mean_wr_country_c4_short.csv'
