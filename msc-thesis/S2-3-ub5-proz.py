...
project = 'Scenario_2-3_ub5_proz'
var_2019 = 'Variability with installed PV capacity 2019'
var_ref = 'Variability with estimated installed PV capacity for 2050 (8.8TW)' #'Variability with installed PV capacity planned for 2030'
var_calc = 'Variability with estimated PV power production for 2050 as constraint (S2: 8.8TW)'
IC_2019_name = 'Installed PV capacity 2019'
IC_ref_name = 'Installed PV capacity 2050 (8.8TW)'
IC_calc_name = 'Installed PV capacity of scenario 2 (8.8TW)'
...
#IC 2050 IRENA 0.891
target_IC = 8800000 #891000 #ic_reduced_2030.to_array().sum()
