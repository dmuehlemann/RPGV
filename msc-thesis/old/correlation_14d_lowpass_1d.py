...
#######Data2
filename_std_ano = data_folder / 'z_all_std_ano_2days_lowpass_2_0-25.nc'
z_all_std_ano_2 = xr.open_dataset(filename_std_ano)['z']

file_wr = data_folder / 'wr_time-c7_std_2days_lowpass_2_0-25.nc'
...
plt.suptitle("Mean weather regime fields (standardized anomalies 14days lowpass filter (2/0.25) vs. 2days)", fontsize=20)
plt.savefig("../data/fig/wr_plot_14days_lowpass_2_0-25_corr_2days.png")
