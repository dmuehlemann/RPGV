...
for i in range(0,8):
    ...
    temp['NL'] = (temp.BE + temp.NL + temp.LU)/3
    temp = temp.drop(['BE', 'LU'])
    temp['AL'] = (temp.AL + temp.MK + temp.ME)/3
    temp = temp.drop(['MK', 'ME'])
    ninja_season.append(temp)
mean_season = xr.open_dataset(data_folder / 'ninja_season_mean.nc')
mean_season['NL'] = (mean_season.AL + mean_season.BE + mean_season.LU)/3
mean_season = mean_season.drop(['BE', 'LU'])
mean_season['AL'] = (mean_season.AL + mean_season.MK + mean_season.ME)/3
mean_season = mean_season.drop(['MK', 'ME'])
...
ic_reduced_pot['NL'] = ic_reduced_pot.BE + ic_reduced_pot.NL + ic_reduced_pot.LU
ic_reduced_pot = ic_reduced_pot.drop(['BE', 'LU'])
ic_reduced_pot['AL'] = ic_reduced_pot.AL + ic_reduced_pot.MK + ic_reduced_pot.ME
ic_reduced_pot = ic_reduced_pot.drop(['MK', 'ME'])

ic_reduced['NL'] = ic_reduced.BE + ic_reduced.NL + ic_reduced.LU
ic_reduced = ic_reduced.drop(['BE', 'LU'])
ic_reduced['AL'] = ic_reduced.AL + ic_reduced.MK + ic_reduced.ME
ic_reduced = ic_reduced.drop(['MK', 'ME'])

ic_reduced_2030['NL'] = ic_reduced_2030.BE + ic_reduced_2030.NL + ic_reduced_2030.LU
ic_reduced_2030 = ic_reduced_2030.drop(['BE', 'LU'])
ic_reduced_2030['AL'] = ic_reduced_2030.AL + ic_reduced_2030.MK + ic_reduced_2030.ME
ic_reduced_2030 = ic_reduced_2030.drop(['MK', 'ME'])
...
project = 'Scenario_1_less_countries'
