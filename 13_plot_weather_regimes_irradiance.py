...
fig_out = data_folder / 'fig/ssrd_plot.tiff'
...
for i in range(0,wr.wr.max().values+1):
    ...
    if i != 0:
        ...
        cb.set_label(label='Standardized anomalies of surface solar radiation [unitless]',size=12,)
...
# plt.suptitle("Mean weather regime anomalies (surface solar radiation)", fontsize=9,)
