...
#Calculate 30% of load which is used as lb in scenario autarky
...
#Define lower bound for scenario autarky (30% of load --> see above)
...
leg = ax_tot_var.legend(loc=6, bbox_to_anchor=(0.0, 0.77), fontsize=9)
...
ax_var.text(10.5, ax_var.yaxis.get_data_interval().min(), 'Spring', fontsize=7)
ax_var.axvspan(15.5,23.5, facecolor='r', alpha=0.08, label='Summer')
ax_var.text(18.5, ax_var.yaxis.get_data_interval().min(), 'Summer', fontsize=7)
